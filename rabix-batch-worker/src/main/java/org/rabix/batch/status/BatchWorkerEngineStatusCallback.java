package org.rabix.batch.status;
...
public class BatchWorkerEngineStatusCallback extends DefaultEngineStatusCallback {

    private final Logger logger = LoggerFactory.getLogger(BatchWorkerEngineStatusCallback.class);

    private final JobService jobService;
    private final Configuration configuration;

    @Inject
    public BatchWorkerEngineStatusCallback(BackendService backendService, JobService jobService, Configuration configuration) {
